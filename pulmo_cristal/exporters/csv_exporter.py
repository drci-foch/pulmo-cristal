...
class DonorCSVExporter(BaseExtractor):
    ...
    def _define_columns(self) -> List[Dict[str, str]]:
        ...
        return [
            ...
            {"name": "num_cristal", "header": "Numéro CRISTAL", "path": ["informations_donneur", "num_cristal"]},
            {"name": "type_donneur", "header": "Type de donneur", "path": ["informations_donneur", "type_donneur"]},
            {"name": "age", "header": "Âge", "path": ["informations_donneur", "age"]},
            {"name": "sexe", "header": "Sexe", "path": ["informations_donneur", "sexe"]},
            {"name": "groupe_sanguin", "header": "Groupe sanguin", "path": ["informations_donneur", "groupe_sanguin"]},
            ...
            {"name": "combine_hiv", "header": "Combiné HIV", "path": ["serologies", "combine_hiv"]},
            ...
            {"name": "anti_htlv", "header": "Anti-HTLV", "path": ["serologies", "anti_htlv"]},
            {"name": "anti_hcv", "header": "Anti-HCV", "path": ["serologies", "anti_hcv"]},
            {"name": "antigene_hbs", "header": "Antigène HBs", "path": ["serologies", "antigene_hbs"]},
            {"name": "anti_hbc", "header": "Anti-HBc", "path": ["serologies", "anti_hbc"]},
            {"name": "anti_hbs", "header": "Anti-HBs", "path": ["serologies", "anti_hbs"]},
            {"name": "dgv_vhe", "header": "DGV VHE", "path": ["serologies", "dgv_vhe"]},
            {"name": "serologie_anguillulose", "header": "Sérologie Anguillulose", "path": ["serologies", "serologie_anguillulose"]},
            {"name": "syphilis_tpha", "header": "Syphilis TPHA", "path": ["serologies", "syphilis_tpha"]},
            {"name": "anti_cmv", "header": "Anti-CMV", "path": ["serologies", "anti_cmv"]},
            {"name": "anti_ebv", "header": "Anti-EBV", "path": ["serologies", "anti_ebv"]},
            {"name": "anti_toxoplasmose", "header": "Anti-Toxoplasmose", "path": ["serologies", "anti_toxoplasmose"]},
            ...
            {"name": "tabagisme", "header": "Tabagisme", "path": ["habitus", "tabagisme"]},
            {"name": "toxicomanie", "header": "Toxicomanie", "path": ["habitus", "toxicomanie"]},
            
            # Medical history
            {"name": "traitement", "header": "Traitement", "path": ["antecedents", "traitement"]},
            {"name": "hta", "header": "Hypertension artérielle", "path": ["antecedents", "hta"]},
            {"name": "diabete", "header": "Diabète", "path": ["antecedents", "diabete"]},
            {"name": "maladie_broncho_pulmonaire", "header": "Maladie broncho-pulmonaire", "path": ["antecedents", "maladie_broncho_pulmonanire"]},
            
            # Infectious assessment
            {"name": "antibiotherapie", "header": "Antibiothérapie", "path": ["bilan_infectieux", "antibiotherapie"]},
            {"name": "si_oui_preciser", "header": "Antibiotiques précisés", "path": ["bilan_infectieux", "si_oui_preciser"]},
            {"name": "diag_covid19", "header": "Diagnostic COVID-19", "path": ["bilan_infectieux", "diag_covid19"]},
            
            # Hemodynamic assessment
            {"name": "arret_cardiaque_recup", "header": "Arrêt cardiaque récupéré", "path": ["bilan_hemodynamique", "arret_cardiaque_recup"]},
            {"name": "concentre_globulaire", "header": "Concentré globulaire", "path": ["bilan_hemodynamique", "concentre_globulaire"]},
            {"name": "plasma_frais_congele", "header": "Plasma frais congelé", "path": ["bilan_hemodynamique", "plasma_frais_congele"]},
            {"name": "concentre_plaquettaire", "header": "Concentré plaquettaire", "path": ["bilan_hemodynamique", "concentre_plaquettaire"]},
            {"name": "albumine", "header": "Albumine", "path": ["bilan_hemodynamique", "albumine"]},
            {"name": "autres_medicaments", "header": "Autres médicaments", "path": ["bilan_hemodynamique", "autres_medicaments"]},
            
            # Hemodynamic evolution
            {"name": "dopamine", "header": "Dopamine (gamma.k/mn)", "path": ["evolution_hemodynamique", "dopamine"]},
            {"name": "dobutamine", "header": "Dobutamine (gamma.k/mn)", "path": ["evolution_hemodynamique", "dobutamine"]},
            {"name": "adrenaline", "header": "Adrénaline (mg/h)", "path": ["evolution_hemodynamique", "adrenaline"]},
            {"name": "noradrenaline", "header": "Noradrénaline (mg/h)", "path": ["evolution_hemodynamique", "noradrenaline"]},
            ...
            {"name": "PaCO2", "header": "PaCO2 (mmHg)", "path": ["parametres_respiratoires", "PaCO2"]},
            {"name": "PaO2", "header": "PaO2 (mmHg)", "path": ["parametres_respiratoires", "PaO2"]},
            {"name": "CO3H", "header": "CO3H- (mmol/l)", "path": ["parametres_respiratoires", "CO3H"]},
            {"name": "SaO2", "header": "SaO2 (%)", "path": ["parametres_respiratoires", "SaO2"]},
            {"name": "PEEP", "header": "PEEP (cm d'eau)", "path": ["parametres_respiratoires", "PEEP"]},
            
            # Cardiac morphological assessment
            {"name": "fraction_d_ejection", "header": "Fraction d'éjection", "path": ["bilan_cardiaque_morphologique", "fraction_d_ejection"]},
            
            # Thorax assessment
            {"name": "epanchement_gazeux_droit", "header": "Épanchement gazeux droit", "path": ["thorax", "epanchement_gazeux_droit"]},
            {"name": "epanchement_gazeux_gauche", "header": "Épanchement gazeux gauche", "path": ["thorax", "epanchement_gazeux_gauche"]},
            {"name": "epanchement_liquidien_droit", "header": "Épanchement liquidien droit", "path": ["thorax", "epanchement_liquidien_droit"]},
            {"name": "epanchement_liquidien_gauche", "header": "Épanchement liquidien gauche", "path": ["thorax", "epanchement_liquidien_gauche"]},
            {"name": "atelectasie_droit", "header": "Atélectasie droite", "path": ["thorax", "atelectasie_droit"]},
            {"name": "atelectasie_gauche", "header": "Atélectasie gauche", "path": ["thorax", "atelectasie_gauche"]},
            {"name": "contusion_pulmonaire_droit", "header": "Contusion pulmonaire droite", "path": ["thorax", "contusion_pulmonaire_droit"]},
            {"name": "contusion_pulmonaire_gauche", "header": "Contusion pulmonaire gauche", "path": ["thorax", "contusion_pulmonaire_gauche"]},
            {"name": "infiltrat_droit", "header": "Infiltrat droit", "path": ["thorax", "infiltrat_droit"]},
            {"name": "infiltrat_gauche", "header": "Infiltrat gauche", "path": ["thorax", "infiltrat_gauche"]},
            {"name": "images_compatibles_avec_inhalation_droit", "header": "Images compatibles avec inhalation droite", "path": ["thorax", "images_compatibles_avec_inhalation_droit"]},
            {"name": "images_compatibles_avec_inhalation_gauche", "header": "Images compatibles avec inhalation gauche", "path": ["thorax", "images_compatibles_avec_inhalation_gauche"]},
            
            # File information
            {"name": "chemin_relatif", "header": "Chemin du fichier", "path": ["chemin_relatif"]},
            {"name": "date_extraction", "header": "Date d'extraction", "path": ["date_extraction"]},
        ]
    ...
    def export_csv(self, 
        ...
        try:
            with open(output_path, 'w', encoding=self.encoding, newline='') as csvfile:
                writer = csv.DictWriter(csvfile, fieldnames=headers, delimiter=self.delimiter)
                writer.writeheader()
...
def generate_csv_filename(base_name: str = "donneurs_data", include_version: bool = True, 
